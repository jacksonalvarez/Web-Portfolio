...
export default function Home() {
  ...
  const [gameStatus, setGameStatus] = React.useState<"playing" | "won" | "draw" | "">("playing");
  const [lastPlayer, setLastPlayer] = React.useState<1 | 2 | 0>(0);
  //What happens when a tile is clicked
  const setTile = (row: number, col: number, currentPlayer: 1 | 2) => () => {
  ...
  return (
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 100px)", gap: "5px", alignContent: "center", justifyContent: "center", padding: "90px", paddingBottom:"50px", paddingTop:"100px", marginLeft: "100px",marginRight:"100px", background: "#25366994", maxWidth:"600px",borderRadius:"30px"}}>
        <Image
          src={tileMap[0][0] === 1 ? "/x.png" : tileMap[0][0] === 2 ? "/o.png" : "/block.png"}
        ...
        />
        <Image
          src={tileMap[0][1] === 1 ? "/x.png" : tileMap[0][1] === 2 ? "/o.png" : "/block.png"}
          alt="Tik-Tak-Toe Block"
          width={200}
          height={200}
        ...
        />
        <Image
          src={tileMap[0][2] === 1 ? "/x.png" : tileMap[0][2] === 2 ? "/o.png" : "/block.png"}
          alt="Tik-Tak-Toe Block"
          width={200}
          height={200}
        ...
        />
        <Image
          src={tileMap[1][0] === 1 ? "/x.png" : tileMap[1][0] === 2 ? "/o.png" : "/block.png"}
          alt="Tik-Tak-Toe Block"
          width={200}
          height={200}
        ...
        />
          <Image
          src={tileMap[1][1] === 1 ? "/x.png" : tileMap[1][1] === 2 ? "/o.png" : "/block.png"}
          alt="Tik-Tak-Toe Block"
          width={200}
          height={200}
        ...
        />
          <Image
          src={tileMap[1][2] === 1 ? "/x.png" : tileMap[1][2] === 2 ? "/o.png" : "/block.png"}
          alt="Tik-Tak-Toe Block"
          width={200}
          height={200}
        ...
        />
          <Image
          src={tileMap[2][0] === 1 ? "/x.png" : tileMap[2][0] === 2 ? "/o.png" : "/block.png"}
          alt="Tik-Tak-Toe Block"
          width={200}
          height={200}
        ...
        />
          <Image
          src={tileMap[2][1] === 1 ? "/x.png" : tileMap[2][1] === 2 ? "/o.png" : "/block.png"}
          alt="Tik-Tak-Toe Block"
          width={200}
          height={200}
        ...
        />
          <Image
          src={tileMap[2][2] === 1 ? "/x.png" : tileMap[2][2] === 2 ? "/o.png" : "/block.png"}
          alt="Tik-Tak-Toe Block"
          width={200}
          height={200}
